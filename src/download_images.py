...
# Define path and download parameters
# Reccomended to download and use the IMDb-Face CSV from: https://github.com/fwang91/IMDb-Face

DEFAULT_CSV = Path("") # e.g, "data/IMDb-Face.csv"
DEFAULT_OUT_DIR = Path("Data/downloaded_faces")
...
# Here, we define a curated list of MCU actors for optional filtering.
# To use with different actors, modify this list or provide your own. Also ensure the names are as in the CSV.
MCU_ACTORS = [
